...
export default convexAuthNextjsMiddleware(async (request, {convexAuth})=>{
    ...
    if(PublicMatcher(request) && authed){ return nextjsMiddlewareRedirect( request, "/dashboard")
    }

    if(ProtectedMatcher(request) && !authed){ return nextjsMiddlewareRedirect( request, "/auth/sign-in")
    }
    return
},
